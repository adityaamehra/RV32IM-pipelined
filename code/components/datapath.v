...
reg_fet_dec rfd(clk,InstrF,instrD,PCF,PCD,PCPLus4F,PCPlus4D);

// Decode stage of the pipeline

decode_datapath dd(clk,reset,instrD,ResultW,RdW,RegWriteW,ImmSrcD,RdD,RD1D,RD2D,ImmExtD);
reg_dec_exe rde(clk,RD1D,RD1E,RD2D,RD2E,PCD,PCE,RdD,RdE,ImmExtD,ImmExtE,PCPlus4D,PCPlus4E,RegWriteD,RegWriteE,ResultSrcD,ResultSrcE,MemWriteD,MemWriteE,PCSrcD,PCSrcE,ALUSrcD,ALUSrcE,JumpD,JumpE,ALUControlD,ALUControlE);

// Execute stage of the pipeline
execute_datapath ed(clk,reset,RD1E,RD2E,ImmExtE,PCE,ALUSrcE,ALUControlE,Zero,less,lessu,ALUResultE,WriteDataE,PCTargetE);
